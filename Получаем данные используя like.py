"""
Получаем данные по колонке email и шаблону - Like
первый символ в шаблоне нужно использовать знак процента
"""
...
try:
    ...
    select_like = """ SELECT * FROM data_shop
                        WHERE email LIKE '%@webs.com'
                    """
    # Выполнение команды.
    cursor.execute(select_like)
